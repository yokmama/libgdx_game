package com.kayosystem.libgdx.chapter02.lesson04;
...
public class MyGdxGame extends ApplicationAdapter {
    ...
    SpriteBatch batch;
    Texture img;
    Animation<TextureRegion> anim; // アニメーション
    BitmapFont font; // フォント 4
    ...
    public void create() {
        ...
        anim = new Animation<TextureRegion>(0.05f, frames, Animation.PlayMode.LOOP);
